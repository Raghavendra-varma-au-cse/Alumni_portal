    ...
    availableAssessments: [
      {
        ...
        description: "Test your knowledge of ML algorithms and applications",
      },
      {
        id: 4,
        name: "UX Design",
        description:
          "Evaluate your understanding of user experience principles",
      },
    ],
    skillLevels: [
        ...
        <TabsContent value="skills">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your progress in various skills
              </CardDescription>
            </CardHeader>
                  ...
                  <Card key={assessment.id}>
                    ...
                    <CardContent>
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge
                          variant={
                            assessment.score >= 80 ? "default" : "secondary"
                          }
                        >
                          {assessment.score}%
                        </Badge>
        ...
        <TabsContent value="available">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Take new assessments to evaluate your skills
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
