...
const getSessions = () => {
  return [
    { id: 1, mentor: "Alice Johnson", topic: "Career Guidance", date: "2023-06-20", time: "14:00", status: "Upcoming" },
    { id: 2, mentor: "Bob Smith", topic: "Interview Preparation", date: "2023-06-22", time: "10:00", status: "Upcoming" },
    { id: 3, mentor: "Carol Williams", topic: "Resume Review", date: "2023-06-15", time: "11:00", status: "Completed" },
  ]
}
