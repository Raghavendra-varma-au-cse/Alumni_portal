      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">
            Your request has been sent to the mentor.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-center mb-4">
            Thank you for reaching out to one of our alumni mentors. They will
            review your request and get back to you soon.
          </p>
          <p className="text-center mb-4">
            In the meantime, feel free to explore other mentorship opportunities
            or resources on our platform.
          </p>
        </CardContent>
