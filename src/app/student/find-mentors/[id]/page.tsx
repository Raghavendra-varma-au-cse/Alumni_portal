...
const getMentorData = (id) => {
  return {
    ...
    experience: [
      { role: "Senior Software Engineer", company: "Tech Corp", years: "2018-Present" },
      { role: "Software Developer", company: "Startup Inc", years: "2013-2018" },
    ],
    education: [
      { degree: "M.S. Computer Science", school: "Tech University", year: "2013" },
      { degree: "B.S. Computer Science", school: "State University", year: "2011" },
    ]
  }
}
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div className="text-center md:text-left">
              ...
              <CardDescription className="text-xl">{mentor.role} at {mentor.company}</CardDescription>
            </div>
          </div>
        </CardHeader>
