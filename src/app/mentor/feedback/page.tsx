...
export default function FeedbackAndPoints() {
  ...
  const mentees = [
    { id: 1, name: "John Doe", imageUrl: "/placeholder.svg?height=50&width=50", lastSession: "2023-06-15" },
    { id: 2, name: "Jane Smith", imageUrl: "/placeholder.svg?height=50&width=50", lastSession: "2023-06-10" },
  ]
    ...
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Share your thoughts on your recent mentoring sessions</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Earn points by being an active mentor</CardDescription>
            </CardHeader>
            ...
            <CardFooter>
              <p className="text-sm text-muted-foreground">
                Earn points by completing sessions, providing feedback, and sharing resources.
              </p>
            </CardFooter>
          </Card>
        </div>
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>Provide feedback for your recent mentoring sessions</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={mentee.id} className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Last session: {mentee.lastSession}</p>
                  </div>
                </div>
